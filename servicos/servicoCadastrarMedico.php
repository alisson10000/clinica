...
if ($contagemCadastro > 0) {
     ...
     header("Location: http://localhost/clinica/home.php?pagina=2&mensagem=3");
    ...
    if ($contagemCadastro > 0) {
      ...
      header("Location: http://localhost/clinica/home.php?pagina=2&mensagem=1");
    } else {
            header("Location: http://localhost/clinica/home.php?pagina=2&mensagem=2");
    }
}
